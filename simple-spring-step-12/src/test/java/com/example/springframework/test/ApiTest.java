...
import com.example.springframework.test.bean.UserServiceBeforeAdvice;
...
public class ApiTest {
    ...
    public void test_advisor() {
        ...
        advisor.setExpression("execution(* com.example.springframework.test.bean.IUserService.*(..))");
