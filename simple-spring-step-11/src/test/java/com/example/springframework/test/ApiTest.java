...
import com.example.springframework.aop.framework.Cglib2AopProxy;
import com.example.springframework.aop.framework.JdkDynamicAopProxy;
...
import com.example.springframework.test.bean.UserServiceInterceptor;
...
public class ApiTest {
    ...
    public void test_aop() throws NoSuchMethodException {
        AspectJExpressionPointcut pointcut = new AspectJExpressionPointcut("execution(* com.example.springframework.test.bean.UserService.*(..))");
    ...
    public void test_dynamic() {
        ...
        advisedSupport.setMethodMatcher(new AspectJExpressionPointcut("execution(* com.example.springframework.test.bean.IUserService.*(..))"));
    ...
    public void test_proxy_method() {
        ...
        IUserService proxy = (IUserService) Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(), targetObj.getClass().getInterfaces(), new InvocationHandler() {
            // 方法匹配器
            MethodMatcher methodMatcher = new AspectJExpressionPointcut("execution(* com.example.springframework.test.bean.IUserService.*(..))");
